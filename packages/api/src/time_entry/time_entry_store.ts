...
import { Time_Entry, Time_Entry_State, new_time_entry2 } from "./time_entry"
import { CMD_Update_Time_Entry_By_Id } from "./time_entry_context"

export class Time_Entries {
	private _store = writable<Time_Entry[]>([])
